...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/googlecloudmonitoringreceiver v0.137.0
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20251014130507-85e2f266f102 // indirect
	...
	github.com/nginx/nginx-prometheus-exporter v1.5.0 // indirect
...
require (
	...
	github.com/kloudmate/polylang-detector v0.0.0-20251011015940-06b600cfd527
...
// Pin to versions compatible with Go 1.24.4
replace github.com/nginx/nginx-prometheus-exporter => github.com/nginx/nginx-prometheus-exporter v1.4.1
